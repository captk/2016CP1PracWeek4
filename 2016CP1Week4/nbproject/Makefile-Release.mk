...
${OBJECTDIR}/cylinder_overload_menu.o: cylinder_overload_menu.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cylinder_overload_menu.o cylinder_overload_menu.cpp
...
${OBJECTDIR}/quadratic_round.o: quadratic_round.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/quadratic_round.o quadratic_round.cpp
...
${OBJECTDIR}/three_powers.o: three_powers.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/three_powers.o three_powers.cpp
